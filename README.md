...
# Examples
For detailed examples on how to use this module, please refer to the '[example](https://github.com/cypik/terraform-azure-labels/blob/master/_master)' directory within this repository.
